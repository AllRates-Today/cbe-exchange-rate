'use strict';
// Central Bank of Egypt exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/cbe';
...
/** Latest rate for one pair, e.g. getRate('USD', 'EGP', { apiKey }). */
